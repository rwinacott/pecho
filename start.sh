...
#curl -i -H "Content-Type: application/json" -H "Accept: application/json" -X POST --data @/Users/ron.winacott/Development/matching_service/
GSI_artifacts/tests/testJSON/test#11_avg.json http://52.54.36.145:8080
